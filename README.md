...
- [x] Execution abstraction
- [x] Router abstraction
- [x] Downstream MCP client abstraction
- [x] Downstream server registry
- [x] Explicit tool-to-backend routing model
- [ ] Wire remote routes into execution
- [ ] Remote tool discovery aggregation
- [ ] Dynamic downstream server lifecycle
...
- [ ] Timeouts
- [ ] Cancellation propagation across all backends
...
- [ ] Downstream server health metrics
- [ ] Error and saturation dashboards
...
- [ ] Integration tests
- [ ] Contract tests for downstream MCP servers
- [ ] Load testing
- [ ] Container image
